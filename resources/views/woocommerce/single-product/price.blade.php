...
@if(($product->attributes) && ($type == 'variable'))
                ...
                <td class="primary text--bold">
                  <strong>
                    @if($item['display_price'])
                      ...
                      @else
                        <a class="link" href="{!! site_url() !!}/kontakt" target="_blank">Zapytaj o cene</a>
                    @endif
                  </strong>
                </td>
                @if($item['display_price'])
  ...
  @endif
  <!-- produkty z vat z innymi wariantami -->
  @if($vat && (count($product->attributes) > 1) )
  ...
  @endif
  <!-- produkty z vat bez innych wariantów -->
  @if($vat && (count($product->attributes) < 2) )
    <div class="tab-content" id="myTabContent">
      <div class="tab-pane fade show active" id="vat" role="tabpanel" aria-labelledby="vat-tab">
        <table class="table-small mb-5">
          <thead>
